...
(function($) {
	...
	Calendar.prototype.getTitle = function(type) {
		var p = this.options.position.start;
		var theView = type ? type : this.options.view;	
		switch(theView) {
			case 'year':
					...
					.on('show.bs.modal', function() {						
						...
						switch(self.options.modal_type) {
							...
							case "template":
								...
								*/
								// Set selected model for angular js
								var $scope = self.options.$scope;
								$scope.$apply(function () {
						            $scope.selectedEvent = event;
						            var start = new Date(event.start);
						            var end = new Date(event.end);						            
									$scope.selectedEvent.startTimeHour =  start.getHours();
									$scope.selectedEvent.startTimeMin =  start.getMinutes();
									$scope.selectedEvent.endTimeHour =  end.getHours();
									$scope.selectedEvent.endTimeMin =  end.getMinutes();																		
									console.log(self.options.$scope.selectedEvent);
								});
								break;
						}
