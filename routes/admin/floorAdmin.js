...
exports.show = function(req, res) {
	res.render("admin-view/floor/floor-show.html");
};
							...
							if(building){
								...
								floor.remove(function(err){	
									...
									if(err) {
										...
										// Update building uplfloor and downfloor(not necessary)
...
exports.uploadAplist = function(req, res) {
	...
	if(req.body._id && req.files.aplist){
